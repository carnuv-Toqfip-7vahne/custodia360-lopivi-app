    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <Link href="/" className="text-orange-600 hover:text-orange-700 font-medium mb-4 inline-block">
            ← Volver a Inicio
          </Link>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                ...
                propiedad de Sportsmotherland, especializada en cumplimiento de la Ley Orgánica de Protección
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                ...
                <li>Kit de Comunicación: 30€ + IVA pago único</li>
              </ul>
            </div>
