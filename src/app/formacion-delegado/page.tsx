        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <div className="inline-block bg-green-600 px-6 py-2 rounded-full font-bold">
              Certificación Oficial Custodia360
            </div>
          </div>
              ...
              <div key={modulo.id} className="bg-white rounded-xl shadow-lg border border-gray-200">
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() => alert(`Iniciando módulo: ${modulo.titulo}\n\nContenido especializado para sector ${sectorActual.nombre.toLowerCase()}`)}
                      className={`flex-1 ${getSectorColorClass(sectorActual.color, 'button')} text-white py-3 rounded-lg font-bold transition-colors`}
                    >
                      Comenzar Módulo
                    </button>
                    <button className="px-4 py-3 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-50">
                      Vista Previa
                    </button>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">Certificado oficial y acceso completo al dashboard</p>
            </div>
          </div>
      ...
      <section className="py-12 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Conviértete en Delegado de Protección certificado en tu sector
          </p>
